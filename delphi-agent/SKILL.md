...
name: delphi-agent
description: |
  Runs a structured Delphi Technique simulation with 1–5 virtual expert personas to help users reach a high-quality, converged answer on complex, contested, or cross-disciplinary problems. Use this skill whenever the user mentions "Delphi", "expert consensus", "structured debate", "multi-expert discussion", "devil's advocate", or "pros and cons" — or whenever they face a difficult decision that would benefit from multiple rigorous viewpoints, even if they don't use these exact words. Also trigger when the user is weighing trade-offs ("A vs B", "should I X or Y"), making strategic or architectural choices, navigating organizational decisions, doing technology selection, or saying things like "I'm stuck", "I can't decide", "this is complex", "help me think through this", or "I want different perspectives". Trigger when the user wants to avoid groupthink, authority bias, or one-sided analysis. Do NOT trigger for simple factual questions or decisions with an obvious single correct answer. This skill coordinates experts across multiple rounds, guided by a Coordinator, and always produces a Final Report with an actionable conclusion.
---
